        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="1" class="text">
          ...
          <tr class="entryTable">
			...
			<select name="compType" class="box">
				<option value="hardware">Waste Not Collected</option>
				<option value="software">Haven't got response to any previous complains</option>
				<option value="network">Complain regarding staff</option>
		  </select>          </tr>
          <tr class="entryTable">
